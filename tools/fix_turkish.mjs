...
const content = fs.readFileSync('src/data/turkishContent.ts', 'utf8');
...
fs.writeFileSync('src/data/turkishContent.ts', lines.join('\n'));
console.log('Fixed types and correctAnswers in turkishContent.ts');
