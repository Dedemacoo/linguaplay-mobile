...
const styles = StyleSheet.create({
  ...
  plans: { flexDirection: 'row', paddingHorizontal: 16, gap: 10, marginBottom: 24 },
  planCard: {
    flex: 1, backgroundColor: '#242433', borderRadius: 16, padding: 14,
    alignItems: 'center', borderWidth: 1.5, borderColor: '#333',
  },
  badge: { borderRadius: 8, paddingHorizontal: 8, paddingVertical: 3, marginBottom: 8 },
  badgeText: { color: '#FFF', fontSize: 10, fontWeight: '700' },
  planTitle: { color: '#FFF', fontWeight: '600', fontSize: 13, marginBottom: 4 },
