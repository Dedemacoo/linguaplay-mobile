                  ...
                  >
                    ...
                    <View style={styles.gameCardInfo}>
                      <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
                        <Text style={[styles.gameCardTitle, { color: colors.text }]}>Lingo'yla Pratik Yap</Text>
                        <View style={[styles.gameBadge, { backgroundColor: '#8B5CF6' }]}>
                          <Text style={styles.gameBadgeText}>YENİ</Text>
                        </View>
                      </View>
                      <Text style={[styles.gameCardDesc, { color: colors.textLight }]}>AI koçumuz Lingo ile {langLabel} pratik yap</Text>
                    </View>
